...
- **Normative merge/resolution semantics for the standardized context schema**
  ...
  the committed file. 20 properties assert totality and determinism by exhaustive
  enumeration over a declared, printed bound, and each is paired with one of 21
