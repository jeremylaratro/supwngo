"""
Configuration management for SupwnGo.
"""
...
class Config:
    """
    Main configuration class for SupwnGo.

    Configuration can be loaded from:
    1. Default values
    2. Config file (~/.supwngo/config.json)
    3. Environment variables (SUPWNGO_*)
    4. Command line arguments
    """

    # General settings
    output_dir: str = "./supwngo_output"
    verbose: int = 1
    database_path: str = "~/.supwngo/supwngo.db"
    ...
    local_libc_dir: str = "~/.supwngo/libcs"
    ...
    def load(cls, config_path: Optional[str] = None) -> "Config":
        ...
        default_path = Path.home() / ".supwngo" / "config.json"
        if config_path:
    ...
    def _load_from_env(self) -> None:
        ...
        env_mapping = {
            "SUPWNGO_OUTPUT_DIR": "output_dir",
            "SUPWNGO_VERBOSE": ("verbose", int),
            "SUPWNGO_AFL_PATH": "afl_path",
            "SUPWNGO_HONGGFUZZ_PATH": "honggfuzz_path",
            "SUPWNGO_GDB_PATH": "gdb_path",
            "SUPWNGO_LIBC_DB_URL": "libc_database_url",
        }
    ...
    def save(self, config_path: Optional[str] = None) -> None:
        ...
        if config_path:
            ...
            path = Path.home() / ".supwngo" / "config.json"
